export const DEFAULT_COMPANY_SETTINGS = {
  ...
  seoTitleAr: "ATOI | حلول برمجية للشركات في البحرين",
  seoDescriptionEn:
  ...
  seoDescriptionAr:
    "ATOI استوديو برمجيات في البحرين، نصمم ونطوّر مواقع إلكترونية وتطبيقات ويب وأنظمة داخلية للشركات في البحرين وخارجها.",
};
