...
export default async function AdminTeamPage() {
  ...
  return (
    <div>
      <PageHeader title="Team" description="Internal team members who can be assigned to projects." />
            ...
            {members.map((m) => (
              <tr key={m.id} className="border-b border-black/5 last:border-0">
                ...
                <td className="px-5 py-3">
                  <Badge label={m.isActive ? "Active" : "Inactive"} tone={m.isActive ? "ACTIVE" : "DISABLED"} />
                </td>
                <td className="px-5 py-3 text-end">
                  <form action={setTeamMemberActiveAction.bind(null, m.id, !m.isActive)}>
