    ...
    <div className="mx-auto max-w-2xl px-5 py-16">
      ...
      <div className="mt-6 space-y-4 text-ink/70">
        <p>
          ...
          you agree to provide accurate contact information so we can respond to you.
        </p>
        <p>
          Project scope, timelines and deliverables are agreed directly between you and{" "}
          {settings.companyName} outside of this website. This site is used to submit requests,
          track project status and progress, and reach our team for support.
        </p>
        <p>
          Contact us at{" "}
