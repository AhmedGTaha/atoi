...
import { setPasswordAction, type SetPasswordState } from "@/app/actions/customerAuthActions";
...
export function SetPasswordForm({ token }: { token: string }) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <AuthInput label="New password" name="password" type="password" autoComplete="new-password" required minLength={8} />
      <AuthInput
