...
import { publishUpdateAction, type PublishUpdateState } from "@/app/actions/projectActions";
...
export function PublishUpdateForm({ projectId }: { projectId: string }) {
  const [state, formAction, isPending] = useActionState(publishUpdateAction, initialState);
